...
var Page = (function PageClosure() {
    ...
    Page.prototype = {
        ...
        getOperatorList: function Page_getOperatorList(handler) {
            ...
            var dataPromises = Promise.all([contentStreamPromise, resourcesPromise], reject);
            ...
            Promise.all([pageListPromise, annotationsPromise]).then(function (datas) {
                ...
                var annotationsReadyPromise = Annotation.appendToOperatorList(annotations, pageOpList, pdfManager, partialEvaluator);
        ...
        extractTextContent: function Page_extractTextContent() {
            ...
            dataPromises.then(function (data) {
                ...
                var bidiTexts = partialEvaluator.getTextContent(contentStream, self.resources);
