    ...
    Font.prototype = {
        ...
        checkAndRepair: function Font_checkAndRepair(name, font, properties) {
            ...
            if (isTrueType) {
                var isGlyphLocationsLong = int16([tables.head.data[50],
                    tables.head.data[51]]);
                sanitizeGlyphLocations(tables.loca, tables.glyf, numGlyphs, isGlyphLocationsLong, hintsValid, dupFirstEntry);
            }
            if (!tables.hhea) {
            ...
            if (properties.type == 'CIDFontType2') {
                ...
                var cmapTable = readCmapTable(tables.cmap, font, this.hasEncoding, this.isSymbolicFont);
                ...
                for (var i = 0; i < cmapMappingsLength; ++i) {
                    ...
                    var unicode = cmapCharcodeToUnicode(charcode, this.isSymbolicFont, cmapPlatformId, cmapEncodingId);
                    if (!unicode) {
        ...
        convert: function Font_convert(fontName, font, properties) {
            ...
            var fields = {
                ...
                'cmap': createCmapTable(charstrings.slice(), ('glyphIds' in font) ? font.glyphIds : null),
                // Font header
                'head': (function fontFieldsHead() {
                    return stringToArray('\x00\x01\x00\x00' + // Version number
                ...
                'maxp': (function fontFieldsMaxp() {
                    return stringToArray('\x00\x00\x50\x00' + // Version number
                ...
                switch (token) {
                    case 'CharStrings':
                        ...
                        while (true) {
                            ...
                            var encoded = decrypt(data.getBytes(), CHAR_STRS_ENCRYPT_KEY, lenIV);
    ...
    CFFParser.prototype = {
        parse: function CFFParser_parse() {
            ...
            if (cff.isCIDFont) {
                ...
                encoding = null;
                charset = this.parseCharsets(topDict.getByName('charset'), cff.charStrings.count, cff.strings, true);
                cff.fdSelect = this.parseFDSelect(topDict.getByName('FDSelect'), cff.charStrings.count);
            }
            else {
                charset = this.parseCharsets(topDict.getByName('charset'), cff.charStrings.count, cff.strings, false);
