...
var NetworkPdfManager = (function NetworkPdfManagerClosure() {
    ...
    function NetworkPdfManager(args, msgHandler) {
        ...
        this.streamManager = new ChunkedStreamManager(args.length, CHUNK_SIZE, args.url, params);
        this.pdfModel = new PDFDocument(this, this.streamManager.getStream(), args.password);
    }
