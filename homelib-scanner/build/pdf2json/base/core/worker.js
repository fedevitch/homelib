    ...
    setup: function wphSetup(handler) {
        ...
        function loadDocument(recoveryMode) {
            ...
            pdfManager.ensureModel('checkHeader', []).then(function () {
                pdfManager.ensureModel('parseStartXRef', []).then(function () {
                    pdfManager.ensureModel('parse', [recoveryMode]).then(parseSuccess, parseFailure);
                }, parseFailure);
            }, parseFailure);
        ...
        handler.on('GetPageRequest', function wphSetupGetPage(data) {
            ...
            pdfManager.getPage(pageIndex).then(function (page) {
                ...
                Promise.all([rotatePromise, refPromise, viewPromise]).then(function (results) {
                    var page = {
        ...
        handler.on('GetDestinations', function wphSetupGetDestinations(data, promise) {
        ...
        handler.on('GetAnnotationsRequest', function wphSetupGetAnnotations(data) {
            pdfManager.getPage(data.pageIndex).then(function (page) {
                pdfManager.ensure(page, 'getAnnotationsData', []).then(function (annotationsData) {
