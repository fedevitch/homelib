...
var PDFPageProxy = (function PDFPageProxyClosure() {
    ...
    PDFPageProxy.prototype = {
        ...
        render: function PDFPageProxy_render(params) {
            ...
            var self = this;
            this.displayReadyPromise.then(function pageDisplayReadyPromise(transparency) {
...
var WorkerTransport = (function WorkerTransportClosure() {
    ...
    WorkerTransport.prototype = {
        ...
        getPageIndex: function WorkerTransport_getPageIndexByRef(ref) {
            var promise = new PDFJS.Promise();
            this.messageHandler.send('GetPageIndex', { ref: ref }, function (pageIndex) {
        ...
        getDestinations: function WorkerTransport_getDestinations() {
            var promise = new PDFJS.Promise();
            this.messageHandler.send('GetDestinations', null, function transportDestinations(destinations) {
                promise.resolve(destinations);
            });
            return promise;
        },
        startCleanup: function WorkerTransport_startCleanup() {
            this.messageHandler.send('Cleanup', null, function endCleanup() {
