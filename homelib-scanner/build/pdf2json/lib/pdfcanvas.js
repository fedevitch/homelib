...
var _CanvasRenderingContext2D__instances, _CanvasRenderingContext2D__drawPDFLine, _CanvasRenderingContext2D__drawPDFFill, _CanvasRenderingContext2D__needRemoveRect;
const nodeUtil = require("util"), PDFLine = require('./pdfline'), PDFFill = require('./pdffill'), PDFFont = require('./pdffont');
...
class CanvasRenderingContext2D_ {
    constructor(canvasTarget, scaledWidth, scaledHeight) {
        _CanvasRenderingContext2D__instances.add(this);
    ...
    rect(aX, aY, aWidth, aHeight) {
        if (__classPrivateFieldGet(this, _CanvasRenderingContext2D__instances, "m", _CanvasRenderingContext2D__needRemoveRect).call(this, aX, aY, aWidth, aHeight)) {
    ...
    stroke(aFill) {
        ...
        for (let i = 0; i < this.currentPath_.length; i++) {
            ...
            switch (p.type) {
                ...
                case 'lineTo':
                    if (!aFill) { //lines
                        if (i > 0) {
                            __classPrivateFieldGet(this, _CanvasRenderingContext2D__instances, "m", _CanvasRenderingContext2D__drawPDFLine).call(this, this.currentPath_[i - 1], p, lineWidth, color);
                        }
                    }
                    break;
                case 'close':
                    if (!aFill) { //lines
                        if (i > 0) {
                            __classPrivateFieldGet(this, _CanvasRenderingContext2D__instances, "m", _CanvasRenderingContext2D__drawPDFLine).call(this, this.currentPath_[i - 1], this.currentPath_[0], lineWidth, color);
                        }
                    }
                    p = null;
                    break;
        ...
        if (aFill) { //fill
            __classPrivateFieldGet(this, _CanvasRenderingContext2D__instances, "m", _CanvasRenderingContext2D__drawPDFFill).call(this, min, min, max, color);
        }
    }
    fill() {
        this.stroke(true);
...
_CanvasRenderingContext2D__instances = new WeakSet(), _CanvasRenderingContext2D__drawPDFLine = function _CanvasRenderingContext2D__drawPDFLine(p1, p2, lineWidth, color) {
...
}, _CanvasRenderingContext2D__drawPDFFill = function _CanvasRenderingContext2D__drawPDFFill(cp, min, max, color) {
    let width = max.x - min.x;
    let height = max.y - min.y;
    let pF = new PDFFill(cp.x, cp.y, width, height, color);
    pF.processFill(this.canvas);
}, _CanvasRenderingContext2D__needRemoveRect = function _CanvasRenderingContext2D__needRemoveRect(x, y, w, h) {
