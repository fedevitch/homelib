...
var _PDFFont_instances, _PDFFont_initTypeName, _PDFFont_initSubType, _PDFFont_initSymbol, _PDFFont_initSpaceWidth, _PDFFont_setFaceIndex, _PDFFont_getFontStyleIndex, _PDFFont_processSymbolicFont, _PDFFont_textRotationAngle;
const nodeUtil = require("util"), PDFUnit = require("./pdfunit"), { kFontFaces, kFontStyles } = require("./pdfconst");
...
class PDFFont {
    // constructor
    constructor(fontObj) {
        _PDFFont_instances.add(this);
        this.fontObj = fontObj;
        this.typeName = __classPrivateFieldGet(this, _PDFFont_instances, "m", _PDFFont_initTypeName).call(this);
        const { subType, bold } = __classPrivateFieldGet(this, _PDFFont_instances, "m", _PDFFont_initSubType).call(this);
        this.subType = subType;
        this.bold = bold;
        this.isSymbol = __classPrivateFieldGet(this, _PDFFont_instances, "m", _PDFFont_initSymbol).call(this);
        this.spaceWidth = __classPrivateFieldGet(this, _PDFFont_instances, "m", _PDFFont_initSpaceWidth).call(this);
        this.fontSize = 1;
        this.faceIdx = 0;
        this.italic = false;
        this.fontStyleId = -1;
    ...
    processText(p, str, maxWidth, color, fontSize, targetData, matrix2D) {
        let text = __classPrivateFieldGet(this, _PDFFont_instances, "m", _PDFFont_processSymbolicFont).call(this, str);
        if (!text) {
            return;
        }
        this.fontStyleId = __classPrivateFieldGet(this, _PDFFont_instances, "m", _PDFFont_getFontStyleIndex).call(this, fontSize);
        ...
        const rAngle = __classPrivateFieldGet(this, _PDFFont_instances, "m", _PDFFont_textRotationAngle).call(this, matrix2D);
        if (rAngle != 0) {
            nodeUtil.p2jinfo(str + ": rotated " + rAngle + " degree.");
            textRun = Object.assign(Object.assign({}, textRun), { RA: rAngle });
        }
        ...
        oneText = Object.assign(Object.assign({}, oneText), colorObj);
...
_PDFFont_instances = new WeakSet(), _PDFFont_initTypeName = function _PDFFont_initTypeName() {
    ...
    return typeName;
}, _PDFFont_initSubType = function _PDFFont_initSubType() {
    ...
    return { subType, bold };
}, _PDFFont_initSymbol = function _PDFFont_initSymbol() {
    ...
    return isSymbol;
}, _PDFFont_initSpaceWidth = function _PDFFont_initSpaceWidth() {
    ...
    return spaceWidth;
}, _PDFFont_setFaceIndex = function _PDFFont_setFaceIndex() {
...
}, _PDFFont_getFontStyleIndex = function _PDFFont_getFontStyleIndex(fontSize) {
    __classPrivateFieldGet(this, _PDFFont_instances, "m", _PDFFont_setFaceIndex).call(this);
    ...
    return retVal;
}, _PDFFont_processSymbolicFont = function _PDFFont_processSymbolicFont(str) {
    let retVal = str;
    if (!str || str.length !== 1)
        return retVal;
    ...
    return retVal;
}, _PDFFont_textRotationAngle = function _PDFFont_textRotationAngle(matrix2D) {
    let retVal = 0;
